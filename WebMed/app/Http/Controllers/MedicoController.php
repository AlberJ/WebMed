...
class MedicoController extends AppBaseController
{
    ...
    public function store(CreateMedicoRequest $request)
    {
        ...
        Flash::success('Medico cadastrado com sucesso.');
    ...
    public function show($id)
    {
        ...
        if (empty($medico)) {
            Flash::error('Medico não encontrado');
    ...
    public function update($id, UpdateMedicoRequest $request)
    {
        ...
        Flash::success('Medico atualizado com sucesso.');
    ...
    public function destroy($id)
    {
        ...
        Flash::success('Medico deletado com êxito.');
